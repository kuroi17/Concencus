...
export default function MainLayout({ children, title, searchSlot }) {
  ...
  return (
    <div className={`grid min-h-screen grid-cols-1 items-start gap-0 bg-gradient-to-b from-[#f8f9fb] to-[#f2f4f7] transition-all duration-300 ease-in-out ${isSidebarCollapsed ? "lg:grid-cols-[80px_1fr]" : "lg:grid-cols-[280px_1fr]"}`}>
      ...
      <div className="flex flex-col min-w-0 h-screen overflow-hidden">
        ...
        <div className="shrink-0 px-4 sm:px-6 lg:px-8 bg-white/70 backdrop-blur-md sticky top-0 z-40 border-b border-slate-200/60">
