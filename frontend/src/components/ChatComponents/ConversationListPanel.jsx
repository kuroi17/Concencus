          ...
          <div className="p-2">
            ...
            {!isSearchingProfiles &&
              searchResults.map((profile) => (
                ...
                >
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-slate-800 dark:bg-slate-700 text-xs font-semibold text-white">
          ...
          <>
            ...
            {!isLoadingConversations && conversations.length === 0 && (
              <div className="flex flex-col items-center justify-center px-4 py-12 text-center">
                <MessageCircleMore size={36} className="mb-3 text-slate-300 dark:text-slate-700" />
                ...
                return (
                  <button
                    ...
                    className={`flex w-full items-center gap-3 rounded-[10px] px-3 py-2.5 text-left transition-all ${
                      isActive
                        ? "bg-[#7f1d1d]/10 dark:bg-red-500/10"
